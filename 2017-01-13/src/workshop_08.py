...
def house_builder(ext,intw,door,window):

	ext_wall_2D = builder_2D(ext)
...
if __name__=='__main__':
	VIEW(house_builder("ext_wall","int_wall","doors","window"))
